...
import com.rlc.akka.cluster.stats.StatsMessages.JobFailed;
import com.rlc.akka.cluster.stats.StatsMessages.StatsJob;
import com.rlc.akka.cluster.stats.StatsMessages.StatsResult;
  ...
  public void onReceive(Object message) {
    if (message.equals("tick") && !nodes.isEmpty()) {
      ...
      Address address = nodesList.get(ThreadLocalRandom.current().nextInt(
          nodesList.size()));
      System.out.println(nodesList.size() + " " + address + servicePath);
